package ru.vsu.cs.edportal.init;
...
import ru.vsu.cs.edportal.service.impl.PasswordEncoder;
...
public class DemoDataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        User user1 = saveUser("drift@prodrive.ru", "Алексей", "Волков", "+7 (916) 555-11-22");
        User user2 = saveUser("shop@tuning.ru", "Дмитрий", "Крылов", "+7 (921) 777-33-44");
        User user3 = saveUser("admin@race.ru", "Сергей", "Петров", "+7 (495) 111-22-33");
    ...
    private User saveUser(String email, String firstName, String lastName, String phone) {
        User u = new User();
        u.setEmail(email);
